...
$default_encryption_key = 'cecyayuda2025'; // Clave de encriptación por defecto
...
function sendEmail($nombre, $folio, $curp, $correo) {
    ...
    try {
        ...
        $mail->SMTPAuth = true;
        $mail->Username = 'dragonflycodes5@gmail.com'; // Tu correo de Gmail
        $mail->Password = 'wnyq kyyx canj gmfz'; // Tu contraseña de Gmail (usa un App Password si es posible)
        $mail->SMTPSecure = PHPMailer::ENCRYPTION_STARTTLS;
        $mail->Port = 587;

        // Remitente y destinatario
        $mail->setFrom('dragonflycodes5@gmail.com', 'DragonFly Codes');
